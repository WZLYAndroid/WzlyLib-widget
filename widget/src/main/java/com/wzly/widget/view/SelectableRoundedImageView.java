...
public class SelectableRoundedImageView extends AppCompatImageView {
    ...
    public SelectableRoundedImageView(Context context, AttributeSet attrs, int defStyle) {
        ...
        mRadius = a.getDimensionPixelSize(
                R.styleable.SelectableRoundedImageView_sriv_radius, 0);
        ...
        if (mRadius != 0) {
            mLeftTopCornerRadius = mRadius;
            mRightTopCornerRadius = mRadius;
            mLeftBottomCornerRadius = mRadius;
            mRightBottomCornerRadius = mRadius;
        }
