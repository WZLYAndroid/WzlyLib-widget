...
public class BaseFontTextView extends AppCompatTextView {
    ...
    protected void initAttr(Context context, AttributeSet attrs) {
        ...
        boolean underline = a.getBoolean(R.styleable.BaseFontTextView_font_underline, false);
    ...
    private void setBoldText(boolean bold, boolean postInvalidate) {
    ...
    private void setUnderline(boolean underline, boolean postInvalidate) {
        getPaint().setFlags(underline ? Paint.UNDERLINE_TEXT_FLAG : 0);
